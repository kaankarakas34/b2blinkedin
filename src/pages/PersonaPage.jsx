...
export const PersonaPage = ({ lang, onOpenModal, onNavigate }) => {
  ...
  const personas = {
    ...
    procurement: {
      ...
      messageAngleTr: 'Tedarikçi güvenilirliği, şeffaf SLA kriterleri ve doğrulanmış ROI/maliyet tasarruf raporları.',
      messageAngleEn: 'Verified vendor credibility, transparent SLA benchmarks, and verifiable cost-reduction analytics.',
